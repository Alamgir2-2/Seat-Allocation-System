        ...
        <div class="row row-cols-1 row-cols-md-3 g-4">
            ...
            <div class="col">
                <div class="card cards">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">Pritilata Hall</h5>
                    </div>
                </div>
            </div>
            <div class="col">
            ...
            <div class="col">
                <div class="card cards">
                    <img src="./images/hall8.jpeg" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h6 class="card-title">Bangamata Begum Fazilatunnessa Mujib Hall</h6>
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="card cards">
                    <img src="./images/hall7.jpeg" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">Al Beruni Hall</h5>
